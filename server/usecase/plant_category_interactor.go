...
// Add is to store plant category's data into database
...
// PlantCategories is to find all plant category's data from database
...
// PlantCategoryByID is to find by plant category's id from database
